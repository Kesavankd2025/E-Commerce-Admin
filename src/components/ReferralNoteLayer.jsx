...
const ReferralNoteLayer = () => {
  ...
  const handleExcelSubmit = async (e) => {
    ...
    try {
      ...
      const res = await ReportApi.excelReferralReport(formattedDates);
            ...
            <div className="d-flex flex-column gap-24">
              ...
              <div className="d-flex align-items-center justify-content-between p-16 radius-12 bg-primary-50 border border-primary-100 flex-wrap gap-3">
                <div className="d-flex align-items-center gap-3">
                  ...
                  <div>
                    <h6 className="text-primary-900 fw-bold mb-0">
                ...
                <div className="col-md-6">
                  <div className="card h-100 border border-neutral-200 shadow-sm bg-base">
                    <div className="card-body p-20">
                      <h6 className="fw-bold text-secondary-light mb-20 border-bottom pb-12 d-flex align-items-center gap-2">
                        <Icon
                      ...
                      <div className="d-flex flex-column gap-16">
                        <div>
                          <span className="d-block text-secondary-light text-sm mb-4">
                            Phone Number
                          </span>
                          <a
